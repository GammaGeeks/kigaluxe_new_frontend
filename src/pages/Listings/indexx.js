        ...
        <div className="ip-fl-container">
          <div className="ip-fl-section">
            <div id="ip-comm-banner" className="custom-ip-banner aios-scroll-section" data-aios-scroll-title="Banner">
              <canvas width="1530" height="581" style="background-image: url(images/banner-with-border-a.png)"></canvas>
          ...
          <div className="ip-fl-section">
            <div id="ip-comm-content" className="ip-fl-listing-container aios-scroll-section" data-aios-scroll-title="Communities">
              <div className="ip-fl-bg attachment-fixed">
                <canvas width="1600" height="1068" style="background-image: url('images/fl-bg.jpg');"></canvas>
              </div>
              ...
              <div className="ip-fl-listing-main">
                <div className="custom-container">
                  ...
                  <div className="ip-fl-listing-caption" data-aos-once="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                      ...
                      <a href="https://serioestates.com/homes-for-sale-details/10644-BELLAGIO-ROAD-LOS-ANGELES-CA-90077/24396691/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            ...
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1075834480/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcyMDU0ODQ5Mw/Kxmuw5uFnsF_mv_dlJQh2n-CuPZVDr_ku1WRsfBIsYY" alt="Featured Listings" width="488" height="484" id="24396691"/>
                            {/* <!-- <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1075834480/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcyMDU0ODQ5Mw/Kxmuw5uFnsF_mv_dlJQh2n-CuPZVDr_ku1WRsfBIsYY" alt="Featured Listings" width="488" height="484"> --> */}
                          </div>
                          ...
                          <div className="ip-fl-listing-hover">
                            ...
                            <div className="ip-fl-listing-info">
                              ...
                              <span> N/A Sq.ft. <em className="ai-icon-sqft"></em>
                              </span>
                            </div>
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/729-BEL-AIR-ROAD-LOS-ANGELES-CA-90077/24386575/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1073249848/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNjA3MDMyOQ/ko-C9oWmTFpGo0aAiWal2LYmZoOdVEe01d3lW5x1XV0" alt="Featured Listings" width="488" height="484" id="24386575" />
                          ...
                          <div className="ip-fl-listing-hover">
                            ...
                            <div className="ip-fl-listing-info">
                              ...
                              <span>
                                <span>12 Baths <em className="ai-icon-bath"></em>
                                </span>
                                <span> 18,784 Sq.ft. <em className="ai-icon-sqft"></em>
                                </span>
                              </span>
                            </div>
                            <div className="ip-fl-listing-hover-btn">
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/1200-BEL-AIR-ROAD-LOS-ANGELES-CA-90077/24402569/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1076545711/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxODY1NDA4MA/w2T_-Sw55k5Hz8XzFTDExt77B0tGmyew-cl5b4vaSTw" alt="Featured Listings" width="488" height="484" id="24402569"/>
                            {/* <!-- <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1076545711/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxODY1NDA4MA/w2T_-Sw55k5Hz8XzFTDExt77B0tGmyew-cl5b4vaSTw" alt="Featured Listings" width="488" height="484"> --> */}
                          </div>
                          <div className="mls-logo-overlay">
                            <img src="images/mls-logo.png" alt="Featured Listings" width="170" height="101"/>
                          </div>
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/9505-GLOAMING-BEVERLY-HILLS-CA-90210/23321859/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1046941072/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNjA1NDQ4MA/fCT7QnIizeaevAYzyD02rcvs2bKkYSZshaeU624W01I" alt="Featured Listings" width="488" height="484" id="23321859" />
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/10936-CHALON-ROAD-LOS-ANGELES-CA-90077/24399189/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1076162575/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNzY5NDE0Mw/m2-Xbtzve-vt2CLQgXwtX3xpUaBxQJD8hIQzHUY4E1Q" alt="Featured Listings" width="488" height="484" id="24399189" />
                            {/* <!-- <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1076162575/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNzY5NDE0Mw/m2-Xbtzve-vt2CLQgXwtX3xpUaBxQJD8hIQzHUY4E1Q" alt="Featured Listings" width="488" height="484"> --> */}
                          </div>
                          <div className="mls-logo-overlay">
                            <img src="images/mls-logo.png" alt="Featured Listings" width="170" height="101" />
                          </div>
                          <div className="ip-fl-listing-hover">
                            ...
                            <div className="ip-fl-listing-hover-address">
                              <span>10936 Chalon Road <br /> Los Angeles, CA 90077 </span>
                            </div>
                            <div className="ip-fl-listing-info">
                              <span>9 Beds <em className="ai-icon-bed"></em>
                              </span>
                              ...
                              <span> 14,941 Sq.ft. <em className="ai-icon-sqft"></em>
                              </span>
                            </div>
                            <div className="ip-fl-listing-hover-btn">
                              <span className="global-btn">Read More</span>
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/9904-KIP-DRIVE-BEVERLY-HILLS-CA-90210/24387189/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1073293106/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNjA3MDMzMQ/Vsls0Z27ELSBAPJ2WlGW7PAJus4_VhjLsv_0noGOiXY" alt="Featured Listings" width="488" height="484" id="24387189" />
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/1420-DAVIES-DRIVE-BEVERLY-HILLS-CA-90210/24412907/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1077489832/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcyMTA2MTQ1Ng/xKu-Fc7VQEUJkarQwaTMZ6EDRLrKhF0RANrTFiNebqg" alt="Featured Listings" width="488" height="484" id="24412907"/>
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/27832-PACIFIC-COAST-HIGHWAY-MALIBU-CA-90265/24384393/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1074084949/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNTk4MDc2Nw/sKllgyiwU6hhCOCDMtTagV-7wmie-0K7jDkPaGC052U" alt="Featured Listings" width="488" height="484" id="24384393"/>
                            {/* <!-- <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1074084949/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNTk4MDc2Nw/sKllgyiwU6hhCOCDMtTagV-7wmie-0K7jDkPaGC052U" alt="Featured Listings" width="488" height="484"> --> */}
                          </div>
                          <div className="mls-logo-overlay">
                            <img src="images/mls-logo.png" alt="Featured Listings" width="170" height="101"/>
                          </div>
                          <div className="ip-fl-listing-hover">
                            ...
                            <div className="ip-fl-listing-hover-address">
                              <span>27832 Pacific Coast Highway <br /> Malibu, CA 90265 </span>
                            </div>
                            <div className="ip-fl-listing-info">
                              <span>6 Beds <em className="ai-icon-bed"></em>
                              </span>
                              <span>
                                <span>7 Baths <em className="ai-icon-bath"></em>
                                </span>
                                <span> 8,775 Sq.ft. <em className="ai-icon-sqft"></em>
                                </span>
                              </span>
                            </div>
                            <div className="ip-fl-listing-hover-btn">
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/1499-BLUERIDGE-DRIVE-BEVERLY-HILLS-CA-90210/24369077/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1063414667/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcyNDEwOTI0Mg/9DbmoVRJ6XhT9-eND5b4tlveAs2yfrt6q2fxdlRiMsw" alt="Featured Listings" width="488" height="484" id="24369077"/>
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/10250-W-SUNSET-BOULEVARD-LOS-ANGELES-CA-90077/22116521/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1008291935/0/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNTE5MzI2Ng/SOPISkQUI3zJ-B0WlvTxZZ-OpJxaNQcKfrZbU5sp1Q8" alt="Featured Listings" width="488" height="484" id="22116521"/>
                            {/* <!-- <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1008291935/0/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNTE5MzI2Ng/SOPISkQUI3zJ-B0WlvTxZZ-OpJxaNQcKfrZbU5sp1Q8" alt="Featured Listings" width="488" height="484"> --> */}
                          </div>
                          <div className="mls-logo-overlay">
                            <img src="images/mls-logo.png" alt="Featured Listings" width="170" height="101"/>
                          </div>
                          <div className="ip-fl-listing-hover">
                            ...
                            <div className="ip-fl-listing-hover-address">
                              <span>10250 W Sunset Boulevard <br /> Los Angeles, CA 90077 </span>
                            </div>
                            <div className="ip-fl-listing-info">
                              <span>17 Beds <em className="ai-icon-bed"></em>
                              </span>
                              <span>
                                <span>12 Baths <em className="ai-icon-bath"></em>
                                </span>
                                <span> 30,000 Sq.ft. <em className="ai-icon-sqft"></em>
                                </span>
                              </span>
                            </div>
                            <div className="ip-fl-listing-hover-btn">
                    ...
                    <div className="ip-fl-listing-item" data-aos-once="true" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                      <a href="https://serioestates.com/homes-for-sale-details/107-DELFERN-DRIVE-LOS-ANGELES-CA-90077/24386085/306/">
                        <div className="ip-fl-listing-img-holder">
                          <div className="ip-fl-listing-img site-img">
                            <canvas width="488" height="484"></canvas>
                            <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1075398905/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNTgwNzMwNA/62xIo_eInb63y4cXk40Rln7yWgNez-uZSCOLGhYy9RA" alt="Featured Listings" width="488" height="484" id="24386085"/>
                            {/* <!-- <img src="https://imageproxy.agentimage.com/488x484/https://api-trestle.corelogic.com/trestle/Media/CRMLS/Property/PHOTO-jpeg/1075398905/1/Mzc4LzgzMDEvMjA/MjAvMTY3MTgvMTcxNTgwNzMwNA/62xIo_eInb63y4cXk40Rln7yWgNez-uZSCOLGhYy9RA" alt="Featured Listings" width="488" height="484"> --> */}
                          </div>
                          <div className="mls-logo-overlay">
                            <img src="images/mls-logo.png" alt="Featured Listings" width="170" height="101"/>
                          </div>
                          <div className="ip-fl-listing-hover">
                            ...
                            <div className="ip-fl-listing-hover-address">
                              <span>107 Delfern Drive <br /> Los Angeles, CA 90077 </span>
                            </div>
                            <div className="ip-fl-listing-info">
                              <span>10 Beds <em className="ai-icon-bed"></em>
                              </span>
                              <span>
                                ...
                                <span> 21,000 Sq.ft. <em className="ai-icon-sqft"></em>
                                </span>
                              </span>
                            </div>
                            <div className="ip-fl-listing-hover-btn">
                  ...
                  <div className="ip-fl-listing-more-btn" data-aos-once="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                              ...
                              <div className="btn-group pull-right">
                                  ...
                                  <div className="dropdown-menu pull-right" style="padding: 17px;">
                                    <div className="ihf-container ihf-refine-search-container">
                                      <form id="ihf-mini-search-form" className="form-inline" action="https://serioestates.com/listing-report/Featured-Listings/2434267" method="GET">
                                        <input type="hidden" name="sortBy" value="pd"/>
                                        <div className="row">
                                          <div className="col-xs-6">
                                            <div id="ihf-mini-search-minprice">
                                              ...
                                              <div className="" style="position:relative;">
                                                ...
                                                <input id="ihf-mini-form-minprice" name="minListPrice" className="ihf-mini-form-element form-control ihf-search-form-input" placeholder="No min" aria-label="Min Price" type="text" value="2,000,000"/>
                                              </div>
                                            </div>
                                          </div>
                                          <div className="col-xs-6">
                                            <div id="ihf-mini-search-maxprice">
                                              ...
                                              <div className="" style="position:relative;">
                                                <div className="ihf-label-overlay-money"> $ </div>
                                                <input id="ihf-mini-form-maxprice" name="maxListPrice" className="ihf-mini-form-element form-control ihf-search-form-input" placeholder="No max" aria-label="Max Price" type="text" value=""/>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                ...
                                <div className="btn-group">
                                  ...
                                  <form id="ihf-sort-search-form" action="https://serioestates.com/listing-report/Featured-Listings/2434267" method="GET">
                                    <input id="minListPrice" name="minListPrice" type="hidden" value="2,000,000"/>
                                    <input id="maxListPrice" name="maxListPrice" type="hidden" value=""/>
                                    <input id="bedrooms" name="bedrooms" type="hidden" value=""/>
                                    <input id="bathCount" name="bathCount" type="hidden" value=""/>
                                    <input type="hidden" id="ihf-search-sort" name="sortBy" value=""/>
                                  </form>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="row ">
                              ...
                              <div className="ihf-grid-result-container well">
                                ...
                                <div className="row">
                                  <div className="col-xs-3">
                                    <div className="ihf-grid-results-logo" style="background-image:url(images/shim.gif); "></div>
                                  </div>
                            ...
                            <div className="ihf-grid-result col-xs-6" data-ihf-event="listing-result-loaded" data-ihf-listing-number="24388903" data-ihf-listing-board-id="306" data-ihf-listing-price="89900000.000000000000" data-ihf-listing-address="73 Beverly Park Lane, Beverly Hills, CA 90210" data-ihf-listing-postal-code="90210" data-ihf-listing-agent-code="">
                              <div className="ihf-grid-result-container well">
                                ...
                                <div className="row"><div className="col-xs-3"><div className="ihf-grid-results-logo" style="background-image:url(images/shim.gif); "></div></div><div className="col-xs-9 pull-left fs-11 "><div className="ihf-grid-result-mlsnum-proptype">#24388903 | House </div></div>
                                </div>
...
<div className="ihf-grid-result col-xs-6" data-ihf-event="listing-result-loaded" data-ihf-listing-number="24386085" data-ihf-listing-board-id="306" data-ihf-listing-price="75000000.000000000000" data-ihf-listing-address="107 Delfern Drive, Los Angeles, CA 90077" data-ihf-listing-postal-code="90077" data-ihf-listing-agent-code="">
...
</div>undefined<div className="mt-60 fs-11" style="text-align:left;">
  <div id="ihf-board-disclaimers">
    ...
    <div className="ihf-board-disclaimer-text"> Based on information from CSMAR, CRMLS, and/or CLAW, and/or CRISNet MLS as of August 26, 2024 1:49 AM PT. The information being provided by CSMAR, CRMLS and/or CLAW and/or CRISNet MLS is for the visitor's personal, non-commercial use and may not be used for any purpose other than to identify prospective properties the visitor may be interested in purchasing. Any information relating to a property referenced on this website comes from the Internet Data Exchange ('IDX') program of CSMAR, CRMLS and/or CLAW, and/or CRISNet MLS. This website may reference real estate listing(s) held by a brokerage firm other than the broker and/or agent who owns this website. Any information relating to a property, regardless of source, including but not limited to square footage and lot sizes, is deemed reliable but not guaranteed and should be personally verified through personal inspection by and/or with the appropriate professionals. The data contained herein is copyrighted by CSMAR, CRMLS and/or CLAW, and/or CRISNet MLS and is protected by all applicable copyright laws. Any dissemination of this information is in violation of copyright laws and is strictly prohibited. <em>IDX powered by iHomefinder, Inc.</em>
                          ...
                          </div><div className="row"><div className="col-xs-6"><ul className="pagination"><li className="disabled"><a href="#">«</a></li><li className="disabled"><a href="#">1 of 25</a></li><li><a href="https://serioestates.com/listing-report/Featured-Listings/2434267?pg=1&amp;sortBy=pd">»</a></li></ul></div></div><div className="mt-60 fs-11" style="text-align:left;"><div id="ihf-board-disclaimers"><img src="images/shim.gif" /><div className="ihf-board-disclaimer-text"> Based on information from CSMAR, CRMLS, and/or CLAW, and/or CRISNet MLS as of August 26, 2024 1:49 AM PT. The information being provided by CSMAR, CRMLS and/or CLAW and/or CRISNet MLS is for the visitor's personal, non-commercial use and may not be used for any purpose other than to identify prospective properties the visitor may be interested in purchasing. Any information relating to a property referenced on this website comes from the Internet Data Exchange ('IDX') program of CSMAR, CRMLS and/or CLAW, and/or CRISNet MLS. This website may reference real estate listing(s) held by a brokerage firm other than the broker and/or agent who owns this website. Any information relating to a property, regardless of source, including but not limited to square footage and lot sizes, is deemed reliable but not guaranteed and should be personally verified through personal inspection by and/or with the appropriate professionals. The data contained herein is copyrighted by CSMAR, CRMLS and/or CLAW, and/or CRISNet MLS and is protected by all applicable copyright laws. Any dissemination of this information is in violation of copyright laws and is strictly prohibited. <em>IDX powered by iHomefinder, Inc.</em></div></div></div>
                        </div>
