...
<div className="textwidget custom-html-widget">
  {/* <div className="ip-banner" data-type="page" data-id="0">
      ...
      <div className="ip-ld-container">
        <div className="ip-ld-section">
          <div id="ip-hero" className="ip-ld-hero-container aios-scroll-section">
            <div className="ip-ld-hero-slide">
              {
                transitions((styles, item) => (
                  <animated.div style={styles} className="ip-ld-hero-slide-item">
          ...
          <div id="ip-content" className="ip-ld-content-main-container aios-scroll-section" data-aios-scroll-title="Communities">
              ...
              <div className="container">
                <div className="ip-ld-content-row">
                  <div className="global-title">
                    <h2>
                      <span><em className="global-logo-icon"><i className="global-outline"></i></em>{property.title}</span>
            ...
            {/* <div className="ip-ld-disclaimer">
              ...
              <p> 
                ...
                The information being provided by CSMAR, CRMLS and/or CLAW and/or CRISNet MLS is for the visitor's personal, 
                non-commercial use and may not be used for any purpose other than to identify prospective properties the visitor may be interested in purchasing. 
                Any information relating to a property referenced on this website comes from the Internet Data Exchange ('IDX') program of CSMAR, 
                CRMLS and/or CLAW, and/or CRISNet MLS. This website may reference real estate listing(s) held by a brokerage firm other than the broker and/or agent who owns this website. 
