...
export default (state = properties, { type, payload }) => {
  switch (type) {
    case propertiesTypes.SEARCH_PROPERTIES_START:
    ...
    case propertiesTypes.SEARCH_PROPERTIES_SUCCESS:
      return produce(state, (draft) => {
        draft.loading = false;
    ...
    case propertiesTypes.SEARCH_PROPERTIES_FAILURE:
      return produce(state, (draft) => {
        draft.loading = false;
    ...
    case propertiesTypes.SEARCH_PROPERTIES_END:
      return produce(state, (draft) => {
        draft.loading = false
        draft.getProperties.loading = false
      })
